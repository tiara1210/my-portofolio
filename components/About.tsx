...
<div className="text-center mb-8">
      ...
      <div className="absolute left-8 top-1/4 animate-float-slow">
        ...
        >
          <svg className="w-8 h-8 text-white group-hover:text-gray-900 transition-colors duration-300" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className="absolute right-8 top-1/3 animate-float">
        ...
        >
          <svg className="w-8 h-8 text-white group-hover:text-blue-400 transition-colors duration-300" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className="absolute left-12 bottom-1/4 animate-float-slower">
        ...
        >
          <svg className="w-8 h-8 text-white group-hover:brightness-110 transition-all duration-300" viewBox="0 0 24 24" fill="currentColor">
